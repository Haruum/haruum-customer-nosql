"""
Django settings for haruum_customer project.
...
ROOT_URLCONF = 'haruum_customer.urls'
...
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'haruum_customer.exception_config.custom_exception_handler',
}

WSGI_APPLICATION = 'haruum_customer.wsgi.application'
